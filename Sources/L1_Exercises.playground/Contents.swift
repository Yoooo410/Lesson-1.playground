...
let nounArray2 = ["Red", "Blue", "Black", "White", "Yellow", "Brown", "Pink", "Gray", "Gold"]

let randNum1 = Int(arc4random_uniform(9))
let randNum2 = Int(arc4random_uniform(9))

let yourSentence = "The \(nounArray2[3]) spilled her \(nounArray2[4])."
let yourSillySentence = "The \(nounArray2[index1]) jumped over the \(nounArray2[index2])."
//: ### Exercise 2
//: Recreate the shoutString by using the didYouKnowString as a stem.
let didYouKnowString = "Did you know I am a super man?"
let whisperString = "psst" + ", " + didYouKnowString.lowercased()
let shoutString =  "HEY! Did you know I am a super man??"
...
//let newString = "$ \(numOfPennies:Double)"
var dollerOfPennies = Double(numOfPennies) / 100
print("$ \(dollerOfPennies)")
